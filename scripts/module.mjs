...
const ignoredPackIds = ['chris-premades.CPRSummonFeatures', 'chris-premades.CPRSummonFeatures2024', 'chris-premades.CPRSpellFeatures', 'chris-premades.CPRClassFeatureItems', 'chris-premades.CPRItemFeatures', 'chris-premades.CPRFeatureItems2024'];
Hooks.once('catReady', () => {
